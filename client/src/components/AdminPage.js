...
function getCustomerWhatsAppLink(phone) {
  if (!phone) return '#';
          ...
          <div className="space-y-3">
            <section>
              <div className="flex justify-between items-center mb-1">
                ...
                {order.phone && (
                  <a
                    href={getCustomerWhatsAppLink(order.phone)}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-600 hover:bg-green-700 text-white rounded-lg text-xs font-bold transition shadow-sm"
                  >
                  ...
                  <tbody>
                    {groupOrders.map(order => (
                      <tr key={order.orderId} className="border-b border-gray-300 hover:bg-gray-50 transition">
                        ...
                        <td className="border-r border-gray-300 px-2 py-1 align-middle">
                          <div className="flex items-center justify-between gap-2">
                            <div className="cursor-pointer min-w-0" onClick={() => setModalOrder(order)}>
                            ...
                            {order.phone && (
                              <a
                                ...
                                title={`Chat with ${order.name} on WhatsApp`}
                                className="p-1.5 bg-green-600 hover:bg-green-700 text-white rounded-lg flex items-center justify-center transition shadow-sm shrink-0"
                              >
                                <WhatsAppIcon className="w-3.5 h-3.5" />
                              </a>
                            )}
